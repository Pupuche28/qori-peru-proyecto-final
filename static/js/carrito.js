document.addEventListener('DOMContentLoaded', () => {
    ...
    // Función para renderizar el resumen del carrito en tipoentrega.html
    ...
    // Función para mostrar notificación (para agregar productos al carrito)
    const showToast = (message, type = 'success') => {
        const toastContainer = document.getElementById('toast-container');
        const toast = document.createElement('div');
        toast.classList.add('toast', 'align-items-center', 'text-white', 'bg-' + (type === 'success' ? 'success' : 'danger'), 'border-0');
    ...
    // Lógica de agregar al carrito (usado en ceramica.html y otros)
    ...
    // Eventos para aumentar/disminuir cantidad o eliminar en carrito.html
    ...
    // Renderizar el resumen del carrito si estamos en tipoentrega.html
